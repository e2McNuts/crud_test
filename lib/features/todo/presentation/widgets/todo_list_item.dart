      ...
      for (var docs in event.docs) {
        if (docs.id == widget.data.todoList) {
          setState(() {
            ...
            _todListColorLight = HSLColor.fromColor(Color(docs['color'])).withLightness(.85).toColor();
            _todListColorDark = HSLColor.fromColor(Color(docs['color'])).withLightness(.4).toColor();
          });
          break;
        }
      }
